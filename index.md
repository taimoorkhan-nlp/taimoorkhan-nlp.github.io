...
Prior to my present designation since 2022, I served in academia for 11 years. I was Assistant Professor (Computer Science) at NUCES, Islamabad, Pakistan from 2014 to 2022. Before that, I worked as a Lecturer (Computer Science) at COMSATS University, Pakistan. Before joining academia, I worked as Software developer on contractual positions for multiple organizations in Pakistan and Australia between 2007 and 2011.

Some of the core skills I have acquired through my experience are Programming (C++, PHP, Python, Java, Javascript), DBMS (SQL, NoSQL), Language processing tools & techniques (NLTK, WordNet, topic modeling, sentiment analysis etc.), Machine learning (Scikit-learn, tensorflow, keras, LLMs etc.) and network analysis (NetworkX, Gephi etc.). I am also interested in using out-of-limelight techniques for low-resource languages with scarce tools.
